...
# X = data.drop(columns = ['OID_','GSS_CODE','COUNT','COUNT_ldatopic','COUNT_ldatopic0','COUNT_ldatopic1','COUNT_ldatopic2',
#                          'COUNT_ldatopic3','COUNT_ldatopic4','COUNT_ldatopic5','COUNT_ldatopic6','COUNT_ldatopic7',
#                          'COUNT_topictime2','COUNT_topseason0','COUNT_topseason1','COUNT_toptour0','COUNT_toptour1',
#                          'OBJECTID','GSS_CODE_1','COUNT_1'])
#ldatopic3
...
Y = data['COUNT_toptour1']
X_train,X_test,Y_train,Y_test = train_test_split(X,Y,test_size=0.3,random_state=1)
Lassomodel = Lasso(alpha=0.1)
Lassomodel.fit(X_train,Y_train)
importance = Lassomodel.coef_
...
print(F2)
Rsv = round(Lassomodel.score(X_test,Y_test)*100,2)
print(Rsv)
#F2.to_csv('COUNT_topictime4.csv')